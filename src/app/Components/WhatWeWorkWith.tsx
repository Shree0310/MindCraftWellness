                ...
                <div className="max-w-7xl mx-auto px-8">
                    ...
                    <div className="max-w-4xl mx-auto mb-20">
                        ...
                        <div className="space-y-6 text-lg leading-relaxed" style={{ fontFamily: 'Lora, serif' }}>
                            ...
                            <p className="text-2xl font-semibold text-[#345041] text-center py-4" style={{ fontFamily: 'BrittanySignature, serif' }}>
                                If you&apos;ve ever asked yourself, &ldquo;Do I really need therapy?&rdquo; - you are not alone.
                            </p>
