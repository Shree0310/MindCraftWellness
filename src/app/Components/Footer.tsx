                    ...
                    <div className="grid md:grid-cols-4 gap-8 mb-12">
                        ...
                        <div>
                            ...
                            <ul className="space-y-2" style={{ fontFamily: 'var(--font-dm-sans), sans-serif', fontWeight: 300 }}>
                                <li><a href="/About" className="text-white/80 hover:text-white transition-colors duration-300"><p>{"About Us"}</p></a></li>
                                <li><a href="/what-we-work-with" className="text-white/80 hover:text-white transition-colors duration-300"><p>{"What We Work With"}</p></a></li>
                                <li><a href="/testimonials" className="text-white/80 hover:text-white transition-colors duration-300"><p>{"Testimonials"}</p></a></li>
                                <li><a href="/book-now" className="text-white/80 hover:text-white transition-colors duration-300"><p>{"Book Now"}</p></a></li>
                                <li><a href="/Careers" className="text-white/80 hover:text-white transition-colors duration-300"><p>{"Careers"}</p></a></li>
                            </ul>
                        </div>
                        ...
                        <div>
                            ...
                            <div className="space-y-2 text-white/80" style={{ fontFamily: 'var(--font-dm-sans), sans-serif', fontWeight: 300 }}>
                                ...
                                <div><p>{"📞 +91 9859080910"}</p></div>
                                <div><p>{"📧 mindcraftwellness@gmail.com "}</p></div>
                                <div><p>{"🕒 Mon to Sat - 10:30am to 7pm"}</p></div>
                            </div>
                        </div>
                    </div>
